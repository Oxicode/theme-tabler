        ...
        <div id="accordion" role="tablist">
            <div class="card mb-1">
                <div class="card-header bg-light" id="headingOne" role="tab">
                    <h5 class="mb-0 w-100">
                        <a data-bs-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="collapsed text-dark"><span class="badge bg-warning me-2 mt-n2">1</span>Create your first CRUD</a>
                        <small class="float-end">1-5 min</small>
                    </h5>
                </div>
          ...
          \App\Models\User::updating(function ($entry) {
            ...
            <div class="card mb-1">
                <div class="card-header bg-light" id="headingTwo" role="tab">
                    <h5 class="mb-0 w-100">
                        <a class="collapsed text-dark" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><span class="badge bg-warning me-2 mt-n2">2</span>Learn the basics</a>
                        <small class="float-end">20-30 min</small>
                    </h5>
                </div>
            ...
            <div class="card mb-1">
                <div class="card-header bg-light" id="headingThree" role="tab">
                    <h5 class="mb-0 w-100">
                        <a class="collapsed text-dark" data-bs-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"><span class="badge bg-warning me-2 mt-n2">4</span>Subscribe or purchase</a>
                        <small class="float-end">1-3 min</small>
                    </h5>
                </div>
            ...
            <div class="card mb-1">
                <div class="card-header bg-light" id="headingThree" role="tab">
                    <h5 class="mb-0 w-100">
                        <a class="collapsed text-dark" data-bs-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour"><span class="badge bg-warning me-2 mt-n2">4</span>Hide this notice</a>
                        <small class="float-end">1 min</small>
                    </h5>
                </div>
